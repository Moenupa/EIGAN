...
orientation_path = '../DATA/orientation.csv';
...
list1 = dir([datadir,'Data',net1,'/',sta1,'/*Z.sac']);
...
try 
    ...
    if IsRemoveIR
        pzfile1 = dir([PZpath,'SAC_PZs_*',sta1,'_*H1_*']);
