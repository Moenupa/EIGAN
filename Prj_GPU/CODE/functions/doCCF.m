...
addpath('/gpfs/fs2/scratch/tolugboj_lab/PrjXX_SAmericaNoise/6_Testings/matlab/functions/');
addpath('/gpfs/fs2/scratch/tolugboj_lab/PrjXX_SAmericaNoise/6_Testings/matlab/functions/calc_Rayleigh_disp/');
addpath('/gpfs/fs2/scratch/tolugboj_lab/EI_Interviews_Spring24/Prj_GPU/DATA/')
%%% --- Paths to important files --- %%%
workingdir = '/gpfs/fs2/scratch/tolugboj_lab/PrjXX_SAmericaNoise/6_Testings/matlab/results/ccf_auto/';

datadir = ['/gpfs/fs2/scratch/tolugboj_lab/EI_Interviews_Spring24/Prj_GPU/DATA/']; % @Siyu: should be the file that contains all network data folders
...
orientation_path = '/gpfs/fs2/scratch/tolugboj_lab/EI_Interviews_Spring24/Prj_GPU/DATA/orientation.csv';
